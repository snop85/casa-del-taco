...
// Registro de un Producto que se ha Servidor en Barra
// -----------------------------------------------------
...
{	
	...
	{        
	    ...
	    $titulo      = "Error en productoServido";
	...
	else
	{
      	// Variables para el exito
   		$titulo      = "Exito Servido de Producto";
...
else
{
    ...
    // Despliega mensaje de Error
   	die ("Error en productoServido:<br>Faltaron datos");	
}
